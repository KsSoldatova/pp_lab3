...
def create_dir(dir_name: str) -> str:
    """This function create directory where we must copy our dataset"""
...
def create_copy_dataset(dataset_path: str, dir_copy: str, annotation_name: str) -> None:
    """This function copy our dataset in another directory and
    create csv file with 2 parameters: filename and file's class name"""
    create_dir(dir_copy)
